...
<body style="background-color: #ffff">
  ...
  <div align="center">
    <table class="head-wrap w320 full-width-gmail-android" style="background-color: #f9f8f8" cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        <td background="https://www.filepicker.io/api/file/UOesoVZTFObSHCgUDygC" style="background-color: #ffff" width="100%" height="8" valign="top">
          <div height="8">
          </div>
        </td>
      </tr>
            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Selamat Datang Di Dropshipper 
                        <span class="brand"> <b>BALIYA.ID</b></span></td>
                    </tr>
                  </table>
                      ...
                      <td>
                        <table class="status" bgcolor="#fffeea" cellspacing="0">
                          <tr>
                            ...
                            <td class="status-cell" style="text-align: left;">
                              {{ $details['nama'] }}
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td class="status-cell" style="width: 25px">:</td>
                            <td class="status-cell" style="text-align: left;">{{ $details['email'] }}</td>
                          </tr>
                          <tr>
                            <td class="status-cell">
                              Username
                            ...
                            <td class="status-cell" style="width: 25px">:</td>
                            <td class="status-cell" style="text-align: left;"><b>{{ $details['username'] }}</b></td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td class="status-cell" style="width: 25px">:</td>
                            <td class="status-cell" style="text-align: left;"><b>{{ $details['password'] }}</b></td>
                          </tr>
                          <?php endif ?>
                        </table>
                      </td>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hey {{ $details['nama'] }}, Selamat Anda Sudah Bergabung Dengan <span class="brand"><b>BALIYA.ID</b></span></div>
                        <table class="body-text">
                          <tr>
                            <td class="body-text-cell">
                              Silahkan Login dengan Username dan Password yang sudah diterima Melalui Email ini
                            </td>
                          </tr>
                        </table>
