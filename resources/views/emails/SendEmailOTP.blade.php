            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Berikut Kode OTP :</td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      ...
                      <td>
                        <table class="status" bgcolor="#fffeea" cellspacing="0">
                          <tr>
                            <td class="status-cell" style="font-size: 20px">
                              <b>{{$details['otp']}}</b>
                            </td>
                          </tr>
                        </table>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="body-padded">
                        <div class="body-title">Hay {{$details['nama']}}, Jangan Bagikan Kode OTP ini</div>
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Terimakasi,</p>
                              <p class="body-signature"><img src="https://www.baliya.id/asset/image/logo.png" alt="Baliya" style="max-width: 150px"></p>
                            </td>
                          </tr>
                        </table>
                      </td>
