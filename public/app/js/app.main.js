'use strict';
angular.module('app').controller('AppCtrl', ['$scope', '$http','$rootScope', '$window', '$location',
    function($scope,$scope, $http,$rootScope, $window,$location) {
        ...
        $scope.app = {
            name: 'Sslant Admin - Angular | General',
            version: '4.0.1',
            type: 'crm', // general,hospital,university,music,crm,blog,socialmedia,freelancing,ecommerce
            color: {
                primary: '#673AB7',
                accent: '#FF6E40',
                info: '#26C6DA',
